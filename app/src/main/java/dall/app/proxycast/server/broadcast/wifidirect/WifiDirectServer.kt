...
import dall.app.proxycast.core.AppDevEnvironment
import dall.app.proxycast.core.ThreadEnforcer
import dall.app.proxycast.core.Timber
import dall.app.proxycast.core.ifNotCancellation
import dall.app.proxycast.core.requireNotNull
import dall.app.proxycast.server.ServerDefaults
import dall.app.proxycast.server.broadcast.BroadcastNetworkStatus
import dall.app.proxycast.server.broadcast.BroadcastServerImplementation
import dall.app.proxycast.server.broadcast.DelegatingBroadcastServer
import dall.app.proxycast.server.lock.Locker
...
/**
 * Wi-Fi Direct server implementation
 * Adapted from pyamsoft/tetherfusenet
 */
internal class WifiDirectServer(
    private val config: WiDiConfig,
    private val register: WifiDirectRegister,
    ...
    private fun resolveP2PDeviceIpAddress(device: WifiP2pDevice): InetAddress? {
        return if (Build.VERSION.SDK_INT >= 35) { // Build.VERSION_CODES.VANILLA_ICE_CREAM
            device.ipAddress
        } else {
            null
        }
