...
import dall.app.proxycast.server.broadcast.BroadcastEvent
import dall.app.proxycast.server.broadcast.BroadcastObserver
...
/**
 * Wi-Fi Direct broadcast receiver and event handler
...
internal class WifiDirectReceiver(
    ...
    private val eventBus = MutableSharedFlow<WidiNetworkEvent>(extraBufferCapacity = 64)
